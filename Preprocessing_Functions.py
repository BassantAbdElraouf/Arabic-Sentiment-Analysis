...
# removes consecutive repeated characters
def remove_unusual_sequences(text):
    return re.sub(r'(.)\1+', r'\1', text)

# identify and keep only Arabic words
...
#and applies additional steps such as removing stopwords, lemmatization, and tokenization
...
# applies the same preprocessing steps to the 'review_description' column of the test data
