...
embedding = Embedding(input_dim=1500, output_dim=128, input_length=50)(inputs)
...
history = model.fit(X_train, Y_train, epochs=2, batch_size= 128, validation_data=(validation_articles, validation_labels))
